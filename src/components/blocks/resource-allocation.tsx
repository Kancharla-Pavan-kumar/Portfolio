...
const topItems = [
  {
    ...
    description:
      "A full-stack application to manage academic progress, schedules, and resources.",
    images: [
      {
        src: "/resource-allocation/academic-tracker.png",
        alt: "Academic tracker dashboard interface",
        width: 495,
        height: 186,
      },
    ],
  ...
  },
  {
    ...
    description: "Java, Spring Boot, React, Next.js, PostgreSQL, Firebase & more.",
    images: [
...
const bottomItems = [
  {
    title: "Trading Mentor Landing Page.",
    description:
      "A modern landing page built for a stock-market mentorship platform.",
    images: [
      {
        src: "/resource-allocation/trading-landing.png",
        alt: "Trading mentor landing page",
        width: 305,
        height: 280,
      },
    ],
  ...
  },
  {
    ...
    description:
      "A personal portfolio built using Next.js, Tailwind CSS, and shadcn/ui.",
    images: [
      {
        src: "/resource-allocation/portfolio-preview.png",
  ...
  },
  {
    ...
    description:
      "A Spring Boot microservice with JWT authentication and role-based access.",
    images: [
      {
        src: "/resource-allocation/rest-api-ui.png",
        alt: "REST API documentation interface",
        width: 305,
        height: 280,
      },
    ],
